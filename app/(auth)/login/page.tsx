  ...
  return (
    ...
    >
      ...
      <p className="text-center text-sm text-gray-500 mt-4">
        ...
        <Link href="/register" className="text-ice-500 font-medium hover:underline">
          Sign up
        </Link>
      </p>
    </motion.div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="bg-white/90 backdrop-blur rounded-3xl shadow-xl border border-ice-200/50 p-8 text-center text-gray-500">Loading…</div>}>
      <LoginForm />
    </Suspense>
  );
}
